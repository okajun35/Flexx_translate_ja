/* ====================== flexx.ui.widgets._iframe ======================*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("flexx.ui.widgets._iframe", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var IFrame = flexx.classes.IFrame = function () {
    _pyfunc_op_instantiate(this, arguments);
}
IFrame.prototype = Object.create(flexx.classes.Widget.prototype);
IFrame.prototype._base_class = flexx.classes.Widget.prototype;
IFrame.prototype._class_name = "IFrame";

IFrame.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
IFrame.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_update_url", "check_size"];
IFrame.prototype.__local_properties__ = ["parent", "size"];
IFrame.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title", "url"];

IFrame.prototype._init_phosphor_and_node = function () {
    this.phosphor = this._create_phosphor_widget("iframe");
    this.node = this.phosphor.node;
    return null;
};

IFrame.prototype._update_url = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.node.src = this.url;
    return null;
};
IFrame.prototype._update_url.nobind = true;
IFrame.prototype._update_url._connection_strings = ["url"];

IFrame.prototype.url = function (v) {
    v = (v === undefined) ? "": v;
    v = _pyfunc_str(v);
    if ((_pyfunc_truthy(v) && ((!_pyfunc_op_contains("://", v))))) {
        v = "http://" + v;
    }
    return v;
};
IFrame.prototype.url.nobind = true;
IFrame.prototype.url.default = "";
IFrame.prototype.url.emitter_type = "Property";
