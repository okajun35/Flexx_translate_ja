/* ============ app_examplee1141f05411449102453a1b4924fd603 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_examplee1141f05411449102453a1b4924fd603", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var App = flexx.classes.App = function () {
    _pyfunc_op_instantiate(this, arguments);
}
App.prototype = Object.create(flexx.classes.Widget.prototype);
App.prototype._base_class = flexx.classes.Widget.prototype;
App.prototype._class_name = "App";

App.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
App.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
App.prototype.__local_properties__ = ["parent", "size"];
App.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];
