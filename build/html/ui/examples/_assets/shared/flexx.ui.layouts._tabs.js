...
flexx.define("flexx.ui.layouts._tabs", ["pyscript-std.js", "flexx.ui.layouts._layout", "flexx.ui._widget"], function (_py, flexx_ui_layouts__layout, flexx_ui__widget) {
...
var _phosphor_tabpanel = flexx.require('phosphor/lib/ui/tabpanel');



var TabPanel = flexx.classes.TabPanel = function () {
    _pyfunc_op_instantiate(this, arguments);
}
TabPanel.prototype = Object.create(flexx.classes.Layout.prototype);
TabPanel.prototype._base_class = flexx.classes.Layout.prototype;
TabPanel.prototype._class_name = "TabPanel";

TabPanel.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
TabPanel.prototype.__handlers__ = ["_TabPanel__current_changed_via_prop", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
TabPanel.prototype.__local_properties__ = ["parent", "size"];
TabPanel.prototype.__properties__ = ["base_size", "children", "container", "css_class", "current", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

TabPanel.prototype._TabPanel__current_changed_via_prop = function () {
    var events, w;
    events = Array.prototype.slice.call(arguments);
    w = events[events.length -1].new_value;
    if ((w === null)) {
        this.phosphor.currentWidget = null;
    } else {
        this.phosphor.currentWidget = w.phosphor;
    }
    return null;
};
TabPanel.prototype._TabPanel__current_changed_via_prop.nobind = true;
TabPanel.prototype._TabPanel__current_changed_via_prop._connection_strings = ["current"];

TabPanel.prototype._init_phosphor_and_node = function () {
    var _phosphor_changes_current;
    this.phosphor = new _phosphor_tabpanel.TabPanel();
    this.node = this.phosphor.node;
    _phosphor_changes_current = (function flx__phosphor_changes_current (v, info) {
        if (_pyfunc_truthy(info.currentWidget)) {
            this.current = window.flexx.instances[info.currentWidget.id];
        }
        return null;
    }).bind(this);

    this.phosphor.currentChanged.connect(_phosphor_changes_current);
    return null;
};

TabPanel.prototype.current = function (v) {
    var err_2;
...
TabPanel.prototype.current.nobind = true;
TabPanel.prototype.current.default = null;
TabPanel.prototype.current.emitter_type = "Property";



return {TabPanel: TabPanel, _phosphor_tabpanel: _phosphor_tabpanel};
});
