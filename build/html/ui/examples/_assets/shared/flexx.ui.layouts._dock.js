/* ======================= flexx.ui.layouts._dock =======================*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("flexx.ui.layouts._dock", ["pyscript-std.js", "flexx.ui.layouts._layout"], function (_py, flexx_ui_layouts__layout) {
...
var _phosphor_dockpanel = flexx.require('phosphor/lib/ui/dockpanel');



var DockPanel = flexx.classes.DockPanel = function () {
    _pyfunc_op_instantiate(this, arguments);
}
DockPanel.prototype = Object.create(flexx.classes.Layout.prototype);
DockPanel.prototype._base_class = flexx.classes.Layout.prototype;
DockPanel.prototype._class_name = "DockPanel";

DockPanel.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
DockPanel.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
DockPanel.prototype.__local_properties__ = ["parent", "size"];
DockPanel.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

DockPanel.prototype._add_child = function (widget) {
    this.phosphor.addWidget(widget.phosphor);
    return null;
};

DockPanel.prototype._init_phosphor_and_node = function () {
    this.phosphor = new _phosphor_dockpanel.DockPanel();
...
return {DockPanel: DockPanel, _phosphor_dockpanel: _phosphor_dockpanel};
});
