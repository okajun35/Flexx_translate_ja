...
flexx.define("app_mondriaan", ["pyscript-std.js", "flexx.ui.layouts._box", "flexx.ui._widget"], function (_py, flexx_ui_layouts__box, flexx_ui__widget) {
...
var MyVBox = flexx.classes.MyVBox = function () {
    _pyfunc_op_instantiate(this, arguments);
}
MyVBox.prototype = Object.create(flexx.classes.BoxLayout.prototype);
MyVBox.prototype._base_class = flexx.classes.BoxLayout.prototype;
MyVBox.prototype._class_name = "MyVBox";

MyVBox.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
MyVBox.prototype.__handlers__ = ["_BoxLayout__orientation_changed", "_BoxLayout__padding_changed", "_BoxLayout__set_flexes", "_BoxLayout__spacing_changed", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
MyVBox.prototype.__local_properties__ = ["parent", "size"];
MyVBox.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "orientation", "padding", "parent", "pos", "size", "spacing", "style", "tabindex", "title"];


var Mondriaan = flexx.classes.Mondriaan = function () {
    _pyfunc_op_instantiate(this, arguments);
}
Mondriaan.prototype = Object.create(flexx.classes.Widget.prototype);
Mondriaan.prototype._base_class = flexx.classes.Widget.prototype;
Mondriaan.prototype._class_name = "Mondriaan";

Mondriaan.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
Mondriaan.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
Mondriaan.prototype.__local_properties__ = ["parent", "size"];
Mondriaan.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];


var MyHBox = flexx.classes.MyHBox = function () {
    _pyfunc_op_instantiate(this, arguments);
}
MyHBox.prototype = Object.create(flexx.classes.BoxLayout.prototype);
MyHBox.prototype._base_class = flexx.classes.BoxLayout.prototype;
MyHBox.prototype._class_name = "MyHBox";

MyHBox.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
MyHBox.prototype.__handlers__ = ["_BoxLayout__orientation_changed", "_BoxLayout__padding_changed", "_BoxLayout__set_flexes", "_BoxLayout__spacing_changed", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
MyHBox.prototype.__local_properties__ = ["parent", "size"];
MyHBox.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "orientation", "padding", "parent", "pos", "size", "spacing", "style", "tabindex", "title"];


return {Mondriaan: Mondriaan, MyHBox: MyHBox, MyVBox: MyVBox};
});
