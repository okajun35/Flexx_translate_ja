...
flexx.define("app_classic_web_dev", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size", "on_text_clicked"];
...
Example.prototype.on_text_clicked = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.thelist.children[this.thelist.children.length -1].text = window.Date.now();
    return null;
};
Example.prototype.on_text_clicked.nobind = true;
Example.prototype.on_text_clicked._connection_strings = ["text.mouse_down"];
