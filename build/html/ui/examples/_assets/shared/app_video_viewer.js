...
flexx.define("app_video_viewer", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var videos = {"bbb.mp4 (online)": "http://www.w3schools.com/tags/mov_bbb.mp4", "ice-age.mp4 (online)": "https://dl.dropboxusercontent.com/u/1463853/ice%20age%204%20trailer.mp4"};



var VideoViewer = flexx.classes.VideoViewer = function () {
    _pyfunc_op_instantiate(this, arguments);
}
VideoViewer.prototype = Object.create(flexx.classes.Widget.prototype);
VideoViewer.prototype._base_class = flexx.classes.Widget.prototype;
VideoViewer.prototype._class_name = "VideoViewer";

VideoViewer.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
VideoViewer.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size", "on_select"];
VideoViewer.prototype.__local_properties__ = ["parent", "size"];
VideoViewer.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

VideoViewer.prototype.on_select = function () {
    var ev, events, fname, stub1_seq, stub2_itr;
    ...
    for (stub2_itr = 0; stub2_itr < stub1_seq.length; stub2_itr += 1) {
        ...
        if (_pyfunc_truthy(ev.source.selected)) {
            fname = ev.source.text;
            this.player.source = videos[fname];
        }
    }
    return null;
};
VideoViewer.prototype.on_select.nobind = true;
VideoViewer.prototype.on_select._connection_strings = ["videolist.items*.selected"];



return {VideoViewer: VideoViewer, videos: videos};
});
