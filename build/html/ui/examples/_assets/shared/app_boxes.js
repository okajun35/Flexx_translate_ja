...
flexx.define("app_boxes", ["pyscript-std.js", "flexx.ui.widgets._label", "flexx.ui._widget"], function (_py, flexx_ui_widgets__label, flexx_ui__widget) {
...
var Boxes = flexx.classes.Boxes = function () {
    _pyfunc_op_instantiate(this, arguments);
}
Boxes.prototype = Object.create(flexx.classes.Widget.prototype);
Boxes.prototype._base_class = flexx.classes.Widget.prototype;
Boxes.prototype._class_name = "Boxes";

Boxes.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
Boxes.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
Boxes.prototype.__local_properties__ = ["parent", "size"];
Boxes.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];


var Panel = flexx.classes.Panel = function () {
    _pyfunc_op_instantiate(this, arguments);
}
Panel.prototype = Object.create(flexx.classes.Label.prototype);
Panel.prototype._base_class = flexx.classes.Label.prototype;
Panel.prototype._class_name = "Panel";

Panel.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
Panel.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_text_changed", "_wrap_changed", "check_size"];
Panel.prototype.__local_properties__ = ["parent", "size"];
Panel.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "text", "title", "wrap"];


return {Boxes: Boxes, Panel: Panel};
});
