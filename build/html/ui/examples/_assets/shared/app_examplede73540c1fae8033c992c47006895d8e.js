/* ============ app_examplede73540c1fae8033c992c47006895d8e =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_examplede73540c1fae8033c992c47006895d8e", ["pyscript-std.js", "flexx.ui.widgets._label", "flexx.ui._widget"], function (_py, flexx_ui_widgets__label, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
...
var Content = flexx.classes.Content = function () {
    _pyfunc_op_instantiate(this, arguments);
}
Content.prototype = Object.create(flexx.classes.Widget.prototype);
Content.prototype._base_class = flexx.classes.Widget.prototype;
Content.prototype._class_name = "Content";

Content.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
Content.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
Content.prototype.__local_properties__ = ["parent", "size"];
Content.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];


var SideWidget = flexx.classes.SideWidget = function () {
    _pyfunc_op_instantiate(this, arguments);
}
SideWidget.prototype = Object.create(flexx.classes.Label.prototype);
SideWidget.prototype._base_class = flexx.classes.Label.prototype;
SideWidget.prototype._class_name = "SideWidget";

SideWidget.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
SideWidget.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_text_changed", "_wrap_changed", "check_size"];
SideWidget.prototype.__local_properties__ = ["parent", "size"];
SideWidget.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "text", "title", "wrap"];


return {Content: Content, Example: Example, SideWidget: SideWidget};
});
