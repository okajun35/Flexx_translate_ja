/* ======================== flexx.ui._plotlayout ========================*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("flexx.ui._plotlayout", ["pyscript-std.js", "flexx.ui.layouts._layout"], function (_py, flexx_ui_layouts__layout) {
...
var PlotLayout = flexx.classes.PlotLayout = function () {
    _pyfunc_op_instantiate(this, arguments);
}
PlotLayout.prototype = Object.create(flexx.classes.Layout.prototype);
PlotLayout.prototype._base_class = flexx.classes.Layout.prototype;
PlotLayout.prototype._class_name = "PlotLayout";

PlotLayout.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
PlotLayout.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
PlotLayout.prototype.__local_properties__ = ["parent", "size"];
PlotLayout.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];


return {PlotLayout: PlotLayout};
});
