/* ============ app_example6683ac373c4e3a2341592ab4ce5e4d05 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_example6683ac373c4e3a2341592ab4ce5e4d05", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_color_changed", "check_size"];
...
Example.prototype._color_changed = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.node.style.background = events[events.length -1].new_value;
    return null;
};
Example.prototype._color_changed.nobind = true;
Example.prototype._color_changed._connection_strings = ["c.color"];
