/* ============ app_example0e5a99936a57aee0b3a3deb5a030703b =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_example0e5a99936a57aee0b3a3deb5a030703b", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_add_label_text", "check_size"];
...
Example.prototype._add_label_text = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.label.text = this.label.text + "Yes it is. ";
    return null;
};
Example.prototype._add_label_text.nobind = true;
Example.prototype._add_label_text._connection_strings = ["but.mouse_down"];
