/* ============ app_examplea5098e0076d59dfc6307b3a6ef39b206 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_examplea5098e0076d59dfc6307b3a6ef39b206", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype._change_label = function () {
    ...
    this.label.text = events[events.length -1].new_value;
    return null;
};
Example.prototype._change_label.nobind = true;
Example.prototype._change_label._connection_strings = ["line.text"];
