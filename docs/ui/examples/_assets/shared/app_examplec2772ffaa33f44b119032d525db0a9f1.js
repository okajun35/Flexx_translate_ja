/* ============ app_examplec2772ffaa33f44b119032d525db0a9f1 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_examplec2772ffaa33f44b119032d525db0a9f1", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Example__update_amplitude", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
...
Example.prototype._Example__update_amplitude = function () {
    var events, freq, phase, stub1_, stub2_seq, stub3_itr, x, ydata;
    events = Array.prototype.slice.call(arguments);
    stub1_ = [this.slider1.value, this.slider2.value];
    freq = stub1_[0];phase = stub1_[1];
    ydata = [];
    stub2_seq = this.plot.xdata;
    ...
    for (stub3_itr = 0; stub3_itr < stub2_seq.length; stub3_itr += 1) {
        x = stub2_seq[stub3_itr];
        _pymeth_append.call(ydata, (window.Math.sin(_pyfunc_op_add((_pyfunc_op_mult((_pyfunc_op_mult(_pyfunc_op_mult(freq, x), 2)), window.Math.PI)), phase))));
    }
    this.plot.ydata = ydata;
    return null;
};
Example.prototype._Example__update_amplitude.nobind = true;
Example.prototype._Example__update_amplitude._connection_strings = ["slider1.value", "slider2.value"];
