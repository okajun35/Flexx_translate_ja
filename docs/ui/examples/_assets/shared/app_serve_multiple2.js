...
flexx.define("app_serve_multiple2", ["pyscript-std.js", "flexx.ui.layouts._dock"], function (_py, flexx_ui_layouts__dock) {
...
var MultiApp = flexx.classes.MultiApp = function () {
    _pyfunc_op_instantiate(this, arguments);
}
MultiApp.prototype = Object.create(flexx.classes.DockPanel.prototype);
MultiApp.prototype._base_class = flexx.classes.DockPanel.prototype;
MultiApp.prototype._class_name = "MultiApp";

MultiApp.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
MultiApp.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
MultiApp.prototype.__local_properties__ = ["parent", "size"];
MultiApp.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];


return {MultiApp: MultiApp};
});
