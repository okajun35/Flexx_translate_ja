...
flexx.define("flexx.ui.widgets._label", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var Label = flexx.classes.Label = function () {
    _pyfunc_op_instantiate(this, arguments);
}
Label.prototype = Object.create(flexx.classes.Widget.prototype);
Label.prototype._base_class = flexx.classes.Widget.prototype;
Label.prototype._class_name = "Label";

Label.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
Label.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_text_changed", "_wrap_changed", "check_size"];
Label.prototype.__local_properties__ = ["parent", "size"];
Label.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "text", "title", "wrap"];

Label.prototype._init_phosphor_and_node = function () {
    this.phosphor = this._create_phosphor_widget("div");
    this.node = this.phosphor.node;
    return null;
};

Label.prototype._text_changed = function () {
    var events;
...
Label.prototype._text_changed.nobind = true;
Label.prototype._text_changed._connection_strings = ["text"];

Label.prototype._wrap_changed = function () {
    var events, wrap;
    events = Array.prototype.slice.call(arguments);
    wrap = this.wrap;
...
Label.prototype._wrap_changed.nobind = true;
Label.prototype._wrap_changed._connection_strings = ["wrap"];

Label.prototype.text = function (v) {
    v = (v === undefined) ? "": v;
    return _pyfunc_str(v);
};
Label.prototype.text.nobind = true;
Label.prototype.text.default = "";
Label.prototype.text.emitter_type = "Property";

Label.prototype.wrap = function (v) {
    v = (v === undefined) ? false: v;
    return _pymeth_get.call({0: 0, 1: 1, 2: 2}, v, (_pyfunc_int(_pyfunc_bool(v))));
};
Label.prototype.wrap.nobind = true;
Label.prototype.wrap.default = false;
Label.prototype.wrap.emitter_type = "Property";
