...
flexx.define("app_send_data", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var SendData = flexx.classes.SendData = function () {
    _pyfunc_op_instantiate(this, arguments);
}
SendData.prototype = Object.create(flexx.classes.Widget.prototype);
SendData.prototype._base_class = flexx.classes.Widget.prototype;
SendData.prototype._class_name = "SendData";

SendData.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
SendData.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
SendData.prototype.__local_properties__ = ["parent", "size"];
SendData.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

SendData.prototype.receive_data = function (blob, meta) {
    var data, header, text;
    data = new window.Float64Array(blob);
    text = (function list_comprehension () {var res = [];var i, iter0, i0;iter0 = _pyfunc_range(0, data.length, 1);if ((typeof iter0 === "object") && (!Array.isArray(iter0))) {iter0 = Object.keys(iter0);}for (i0=0; i0<iter0.length; i0++) {i = iter0[i0];{res.push("" + i + ": " + data[i] + "<br />");}}return res;}).apply(this);
    header = "This data was send in binary form:<br />";
    this.label.text = _pyfunc_op_add(header, _pymeth_join.call("", text));
    return null;
};
