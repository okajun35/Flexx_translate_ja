/* ============ app_examplea3a752742f1d3f5ebb456373211108a8 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_examplea3a752742f1d3f5ebb456373211108a8", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_stacked_current", "check_size"];
...
Example.prototype._stacked_current = function () {
    var button, events;
    events = Array.prototype.slice.call(arguments);
    button = events[events.length -1].source;
    this.stack.current = button.w;
    return null;
};
Example.prototype._stacked_current.nobind = true;
Example.prototype._stacked_current._connection_strings = ["buta.mouse_down", "butb.mouse_down", "butc.mouse_down"];
