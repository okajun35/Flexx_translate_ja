/* ============ app_example8178bd1892c8a017b6700a9fbfaac8af =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_example8178bd1892c8a017b6700a9fbfaac8af", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_change_progress", "check_size"];
...
Example.prototype._change_progress = function () {
    ...
    for (stub2_itr = 0; stub2_itr < stub1_seq.length; stub2_itr += 1) {
        ...
        if ((ev.source === this.b1)) {
            this.prog.value -= 0.1;
        } else {
            this.prog.value=_pyfunc_op_add(this.prog.value, 0.1)
        }
    }
    return null;
};
Example.prototype._change_progress.nobind = true;
Example.prototype._change_progress._connection_strings = ["b1.mouse_down", "b2.mouse_down"];
