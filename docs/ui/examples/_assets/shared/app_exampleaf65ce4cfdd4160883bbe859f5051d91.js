/* ============ app_exampleaf65ce4cfdd4160883bbe859f5051d91 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_exampleaf65ce4cfdd4160883bbe859f5051d91", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_change_label", "check_size"];
...
Example.prototype._change_label = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.label.text = _pyfunc_op_mult("x", (events[events.length -1].new_value));
    return null;
};
Example.prototype._change_label.nobind = true;
Example.prototype._change_label._connection_strings = ["slider.value"];
