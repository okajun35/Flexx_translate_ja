...
flexx.define("app_form", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var Form = flexx.classes.Form = function () {
    _pyfunc_op_instantiate(this, arguments);
}
Form.prototype = Object.create(flexx.classes.Widget.prototype);
Form.prototype._base_class = flexx.classes.Widget.prototype;
Form.prototype._class_name = "Form";

Form.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
Form.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
Form.prototype.__local_properties__ = ["parent", "size"];
Form.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];
