...
flexx.define("flexx.ui.widgets._group", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var GroupWidget = flexx.classes.GroupWidget = function () {
    _pyfunc_op_instantiate(this, arguments);
}
GroupWidget.prototype = Object.create(flexx.classes.Widget.prototype);
GroupWidget.prototype._base_class = flexx.classes.Widget.prototype;
GroupWidget.prototype._class_name = "GroupWidget";

GroupWidget.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
GroupWidget.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_keep_legend_up", "_title_changed", "check_size"];
GroupWidget.prototype.__local_properties__ = ["parent", "size"];
GroupWidget.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

GroupWidget.prototype._init_phosphor_and_node = function () {
    var node;
    this.phosphor = new _phosphor_panel.Panel();
    node = window.document.createElement("fieldset");
    this.phosphor._node = node;
...
GroupWidget.prototype._keep_legend_up = function () {
    var events, first;
    events = Array.prototype.slice.call(arguments);
    if (this.children.length) {
        first = this.children[0].outernode;
        this.node.insertBefore(this._legend, first);
    }
    return null;
};
GroupWidget.prototype._keep_legend_up.nobind = true;
GroupWidget.prototype._keep_legend_up._connection_strings = ["children"];

GroupWidget.prototype._title_changed = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this._legend.innerHTML = this.title;
    return null;
};
GroupWidget.prototype._title_changed.nobind = true;
GroupWidget.prototype._title_changed._connection_strings = ["title"];



return {GroupWidget: GroupWidget, _phosphor_panel: _phosphor_panel};
});
