...
flexx.define("flexx.ui.layouts._split", ["pyscript-std.js", "flexx.ui.layouts._layout"], function (_py, flexx_ui_layouts__layout) {
...
var _phosphor_splitpanel = flexx.require('phosphor/lib/ui/splitpanel');



var SplitPanel = flexx.classes.SplitPanel = function () {
    _pyfunc_op_instantiate(this, arguments);
}
SplitPanel.prototype = Object.create(flexx.classes.Layout.prototype);
SplitPanel.prototype._base_class = flexx.classes.Layout.prototype;
SplitPanel.prototype._class_name = "SplitPanel";

SplitPanel.prototype._DEFAULT_ORIENTATION = "h";
SplitPanel.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
SplitPanel.prototype.__handlers__ = ["_SplitPanel__orientation_changed", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
SplitPanel.prototype.__local_properties__ = ["parent", "size"];
SplitPanel.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "orientation", "parent", "pos", "size", "style", "tabindex", "title"];

SplitPanel.prototype._SplitPanel__orientation_changed = function () {
    ...
    if ((_pyfunc_op_equals(ori, 0) || _pyfunc_op_equals(ori, "h"))) {
        this.phosphor.orientation = "horizontal";
    } else if ((_pyfunc_op_equals(ori, 1) || _pyfunc_op_equals(ori, "v"))) {
        this.phosphor.orientation = "vertical";
    } else {
        err_2 = new Error('ValueError:' + ("Invalid splitter orientation: " + ori)); err_2.name = "ValueError"; throw err_2;
    }
    return null;
};
SplitPanel.prototype._SplitPanel__orientation_changed.nobind = true;
SplitPanel.prototype._SplitPanel__orientation_changed._connection_strings = ["orientation"];

SplitPanel.prototype._init_phosphor_and_node = function () {
    this.phosphor = new _phosphor_splitpanel.SplitPanel();
    this.node = this.phosphor.node;
    return null;
};

SplitPanel.prototype.orientation = function (v) {
    var err_2;
    ...
    if ((!_pyfunc_op_contains(v, ["h", "v"]))) {
        err_2 = new Error('ValueError:' + ("" + this.id + ".orientation got unknown value " + _pyfunc_repr(v) + "")); err_2.name = "ValueError"; throw err_2;
    }
    return v;
};
SplitPanel.prototype.orientation.nobind = true;
SplitPanel.prototype.orientation.default = null;
SplitPanel.prototype.orientation.emitter_type = "Property";



return {SplitPanel: SplitPanel, _phosphor_splitpanel: _phosphor_splitpanel};
});
