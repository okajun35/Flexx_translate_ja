/* ======================= app_using_python_in_js =======================*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_using_python_in_js", ["pyscript-std.js", "html.__init__", "flexx.ui._widget"], function (_py, html___init__, flexx_ui__widget) {
...
var escape = html___init__.escape;

var info = {"name": "John", "age": 42};
var version = "3.5.2 (v3.5.2:4def2a2901a5, Jun 25 2016, 22:01:18) [MSC v.1900 32 bit (Intel)]";



var poly;
poly = function flx_poly (x) {
    var coef, coefs, degree, stub1_seq, stub2_itr, y;
    coefs = Array.prototype.slice.call(arguments).slice(1);
    ...
    for (stub2_itr = 0; stub2_itr < stub1_seq.length; stub2_itr += 1) {
        coef = stub1_seq[stub2_itr];
        y=_pyfunc_op_add(y, _pyfunc_op_mult(coef, Math.pow(x, degree)))
        degree -= 1;
    }
    return y;
};
...
var UsingPython = flexx.classes.UsingPython = function () {
    _pyfunc_op_instantiate(this, arguments);
}
UsingPython.prototype = Object.create(flexx.classes.Widget.prototype);
UsingPython.prototype._base_class = flexx.classes.Widget.prototype;
UsingPython.prototype._class_name = "UsingPython";

UsingPython.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
UsingPython.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
UsingPython.prototype.__local_properties__ = ["parent", "size"];
UsingPython.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

UsingPython.prototype.init = function () {
    var lines;
    lines = [];
    _pymeth_append.call(lines, ("This JS was generated from Python " + version));
    _pymeth_append.call(lines, ("Person " + info.name + " is " + info.age + " years old"));
    _pymeth_append.call(lines, ("Evaling 4*x**2 + 5*x + 6 with x=4: " + poly(4, 4, 5, 6)));
    _pymeth_append.call(lines, ("... and with x=12: " + poly(12, 4, 5, 6)));
    _pymeth_append.call(lines, ("String with escaped html: " + escape("html <tags>!")));
    _pymeth_append.call(lines, ("String with escaped html: " + escape("Woezel & Pip")));
    this.label.text = _pymeth_join.call("<br />", lines);
    return null;
};



return {UsingPython: UsingPython, info: info, poly: poly, version: version};
});
