...
flexx.define("flexx.ui.widgets._progressbar", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var ProgressBar = flexx.classes.ProgressBar = function () {
    _pyfunc_op_instantiate(this, arguments);
}
ProgressBar.prototype = Object.create(flexx.classes.Widget.prototype);
ProgressBar.prototype._base_class = flexx.classes.Widget.prototype;
ProgressBar.prototype._class_name = "ProgressBar";

ProgressBar.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
ProgressBar.prototype.__handlers__ = ["_ProgressBar__max_changed", "_ProgressBar__value_changed", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
ProgressBar.prototype.__local_properties__ = ["parent", "size"];
ProgressBar.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "max", "parent", "pos", "size", "style", "tabindex", "title", "value"];

ProgressBar.prototype._ProgressBar__max_changed = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.node.max = events[events.length -1].new_value;
    return null;
};
ProgressBar.prototype._ProgressBar__max_changed.nobind = true;
ProgressBar.prototype._ProgressBar__max_changed._connection_strings = ["max"];

ProgressBar.prototype._ProgressBar__value_changed = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.node.value = events[events.length -1].new_value;
    return null;
};
ProgressBar.prototype._ProgressBar__value_changed.nobind = true;
ProgressBar.prototype._ProgressBar__value_changed._connection_strings = ["value"];

ProgressBar.prototype._init_phosphor_and_node = function () {
    this.phosphor = this._create_phosphor_widget("progress");
    this.node = this.phosphor.node;
    return null;
};

ProgressBar.prototype.max = function (v) {
    v = (v === undefined) ? 1: v;
    return _pyfunc_float(v);
};
ProgressBar.prototype.max.nobind = true;
ProgressBar.prototype.max.default = 1;
ProgressBar.prototype.max.emitter_type = "Property";

ProgressBar.prototype.value = function (v) {
    v = (v === undefined) ? 0: v;
    return _pyfunc_float(v);
};
ProgressBar.prototype.value.nobind = true;
ProgressBar.prototype.value.default = 0;
ProgressBar.prototype.value.emitter_type = "Property";
