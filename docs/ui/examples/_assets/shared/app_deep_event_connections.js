/* ===================== app_deep_event_connections =====================*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_deep_event_connections", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var DeepEventConnections = flexx.classes.DeepEventConnections = function () {
    _pyfunc_op_instantiate(this, arguments);
}
DeepEventConnections.prototype = Object.create(flexx.classes.Widget.prototype);
DeepEventConnections.prototype._base_class = flexx.classes.Widget.prototype;
DeepEventConnections.prototype._class_name = "DeepEventConnections";

DeepEventConnections.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
DeepEventConnections.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size", "on_slider_change"];
DeepEventConnections.prototype.__local_properties__ = ["parent", "size"];
DeepEventConnections.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

DeepEventConnections.prototype.on_slider_change = function () {
    var events, s, stub1_seq, stub2_itr, v;
    events = Array.prototype.slice.call(arguments);
    v = 0;
    stub1_seq = this.box.children;
    if ((typeof stub1_seq === "object") && (!Array.isArray(stub1_seq))) {
        stub1_seq = Object.keys(stub1_seq);
    }
    for (stub2_itr = 0; stub2_itr < stub1_seq.length; stub2_itr += 1) {
        s = stub1_seq[stub2_itr];
        if (_pyfunc_hasattr(s, "value")) {
            v=_pyfunc_op_add(v, s.value)
        }
    }
    this.label.text = "Sum of slider values is " + _pyfunc_str(v);
    return null;
};
DeepEventConnections.prototype.on_slider_change.nobind = true;
DeepEventConnections.prototype.on_slider_change._connection_strings = ["children**.value"];



return {DeepEventConnections: DeepEventConnections};
});
