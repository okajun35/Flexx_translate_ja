...
flexx.define("app_code_editor_ace", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var CodeEditor = flexx.classes.CodeEditor = function () {
    _pyfunc_op_instantiate(this, arguments);
}
CodeEditor.prototype = Object.create(flexx.classes.Widget.prototype);
CodeEditor.prototype._base_class = flexx.classes.Widget.prototype;
CodeEditor.prototype._class_name = "CodeEditor";

CodeEditor.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
CodeEditor.prototype.__handlers__ = ["_CodeEditor__on_size", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
CodeEditor.prototype.__local_properties__ = ["parent", "size"];
CodeEditor.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

CodeEditor.prototype._CodeEditor__on_size = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.ace.resize();
    return null;
};
CodeEditor.prototype._CodeEditor__on_size.nobind = true;
CodeEditor.prototype._CodeEditor__on_size._connection_strings = ["size"];

CodeEditor.prototype.init = function () {
    this.ace = window.ace.edit(this.node, "editor");
    this.ace.setValue("import os\n\ndirs = os.walk");
    this.ace.navigateFileEnd();
