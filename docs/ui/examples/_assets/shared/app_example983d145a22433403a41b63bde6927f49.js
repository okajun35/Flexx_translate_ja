/* ============ app_example983d145a22433403a41b63bde6927f49 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_example983d145a22433403a41b63bde6927f49", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size", "on_combobox_text"];
...
Example.prototype.on_combobox_text = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.label.text = "Combobox text: " + this.combo.text;
    if ((this.combo.selected_index !== null)) {
        this.label.text=_pyfunc_op_add(this.label.text, " (index " + this.combo.selected_index + ")")
    }
    return null;
};
Example.prototype.on_combobox_text.nobind = true;
Example.prototype.on_combobox_text._connection_strings = ["combo.text"];
