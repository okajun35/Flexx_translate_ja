/* ============ app_example89607681a36c173aebe8ddbe57ced1b0 =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_example89607681a36c173aebe8ddbe57ced1b0", ["pyscript-std.js", "flexx.ui.widgets._group"], function (_py, flexx_ui_widgets__group) {
...
Example.prototype = Object.create(flexx.classes.GroupWidget.prototype);
Example.prototype._base_class = flexx.classes.GroupWidget.prototype;
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_change_group_title", "_keep_legend_up", "_title_changed", "check_size"];
...
Example.prototype._change_group_title = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.title = this.title + "-";
    return null;
};
Example.prototype._change_group_title.nobind = true;
Example.prototype._change_group_title._connection_strings = ["but.mouse_down"];
