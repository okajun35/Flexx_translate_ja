/* ============ app_example5f0a5fc5afab88c2c3d6c1cb924b5d2e =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_example5f0a5fc5afab88c2c3d6c1cb924b5d2e", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size", "on_click"];
...
Example.prototype.on_click = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.now.text = window.Date.now();
    return null;
};
Example.prototype.on_click.nobind = true;
Example.prototype.on_click._connection_strings = ["but.mouse_down"];
