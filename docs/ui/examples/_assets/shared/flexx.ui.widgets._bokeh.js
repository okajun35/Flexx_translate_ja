/* ====================== flexx.ui.widgets._bokeh =======================*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("flexx.ui.widgets._bokeh", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
var BokehWidget = flexx.classes.BokehWidget = function () {
    _pyfunc_op_instantiate(this, arguments);
}
BokehWidget.prototype = Object.create(flexx.classes.Widget.prototype);
BokehWidget.prototype._base_class = flexx.classes.Widget.prototype;
BokehWidget.prototype._class_name = "BokehWidget";

BokehWidget.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
BokehWidget.prototype.__handlers__ = ["_BokehWidget__resize_plot", "_BokehWidget__set_plot_components", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
BokehWidget.prototype.__local_properties__ = ["parent", "plot", "size"];
BokehWidget.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "plot", "pos", "size", "style", "tabindex", "title"];

BokehWidget.prototype._BokehWidget__resize_plot = function () {
    ...
    if ((_pyfunc_truthy(this.plot) && _pyfunc_truthy(this.parent))) {
        if (_pyfunc_truthy(this.plot.resize_width_height)) {
            ...
            use_x = !_pyfunc_op_contains(cstyle["overflow-x"], ["auto", "scroll"]);
            use_y = !_pyfunc_op_contains(cstyle["overflow-y"], ["auto", "scroll"]);
...
BokehWidget.prototype._BokehWidget__resize_plot.nobind = true;
BokehWidget.prototype._BokehWidget__resize_plot._connection_strings = ["size"];

BokehWidget.prototype._BokehWidget__set_plot_components = function () {
...
BokehWidget.prototype._BokehWidget__set_plot_components.nobind = true;
BokehWidget.prototype._BokehWidget__set_plot_components._connection_strings = ["_plot_components"];

BokehWidget.prototype.plot = function (plot) {
    plot = (plot === undefined) ? null: plot;
    return plot;
};
BokehWidget.prototype.plot.nobind = true;
BokehWidget.prototype.plot.default = null;
BokehWidget.prototype.plot.emitter_type = "Property";



return {BokehWidget: BokehWidget};
});
