/* ============ app_exampleb8af0d7005e14c0364ff53e7ecf3b6de =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_exampleb8af0d7005e14c0364ff53e7ecf3b6de", ["pyscript-std.js", "flexx.ui._widget"], function (_py, flexx_ui__widget) {
...
Example.prototype.__handlers__ = ["_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size", "make_stretched"];
...
Example.prototype.make_stretched = function () {
    var events;
    events = Array.prototype.slice.call(arguments);
    this.im1.stretch = this.im2.stretch = this.stretch.checked;
    return null;
};
Example.prototype.make_stretched.nobind = true;
Example.prototype.make_stretched._connection_strings = ["stretch.checked"];
