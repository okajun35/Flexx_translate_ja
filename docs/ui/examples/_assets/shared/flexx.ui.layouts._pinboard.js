/* ===================== flexx.ui.layouts._pinboard =====================*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("flexx.ui.layouts._pinboard", ["pyscript-std.js", "flexx.ui.layouts._layout"], function (_py, flexx_ui_layouts__layout) {
...
var PinboardLayout = flexx.classes.PinboardLayout = function () {
    _pyfunc_op_instantiate(this, arguments);
}
PinboardLayout.prototype = Object.create(flexx.classes.Layout.prototype);
PinboardLayout.prototype._base_class = flexx.classes.Layout.prototype;
PinboardLayout.prototype._class_name = "PinboardLayout";

PinboardLayout.prototype.__emitters__ = ["key_down", "key_press", "key_up", "mouse_down", "mouse_move", "mouse_up", "mouse_wheel"];
PinboardLayout.prototype.__handlers__ = ["_PinboardLayout__pos_changed", "_PinboardLayout__size_changed", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "check_size"];
PinboardLayout.prototype.__local_properties__ = ["parent", "size"];
PinboardLayout.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "parent", "pos", "size", "style", "tabindex", "title"];

PinboardLayout.prototype._PinboardLayout__pos_changed = function () {
    ...
    for (stub2_itr = 0; stub2_itr < stub1_seq.length; stub2_itr += 1) {
        ...
        st.left = (_pyfunc_truthy(pos[0] > 1))? (pos[0] + "px") : (_pyfunc_op_mult(pos[0], 100) + "%");
        st.top = (_pyfunc_truthy(pos[1] > 1))? (pos[1] + "px") : (_pyfunc_op_mult(pos[1], 100) + "%");
    }
    return null;
};
PinboardLayout.prototype._PinboardLayout__pos_changed.nobind = true;
PinboardLayout.prototype._PinboardLayout__pos_changed._connection_strings = ["children", "children*.pos"];

PinboardLayout.prototype._PinboardLayout__size_changed = function () {
...
PinboardLayout.prototype._PinboardLayout__size_changed.nobind = true;
PinboardLayout.prototype._PinboardLayout__size_changed._connection_strings = ["children", "children*.base_size"];

PinboardLayout.prototype._init_phosphor_and_node = function () {
...
return {PinboardLayout: PinboardLayout, _phosphor_panel: _phosphor_panel};
});
