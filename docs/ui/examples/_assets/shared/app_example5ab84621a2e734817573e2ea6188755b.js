/* ============ app_example5ab84621a2e734817573e2ea6188755b =============*/

/* Autogenerated code from Flexx. Code Subject to the BSD-2-clause license. */



flexx.define("app_example5ab84621a2e734817573e2ea6188755b", ["pyscript-std.js", "flexx.ui.layouts._box"], function (_py, flexx_ui_layouts__box) {
...
Example.prototype = Object.create(flexx.classes.BoxPanel.prototype);
Example.prototype._base_class = flexx.classes.BoxPanel.prototype;
...
Example.prototype.__handlers__ = ["_BoxPanel__orientation_changed", "_BoxPanel__set_flexes", "_BoxPanel__spacing_changed", "_Widget__children_changed", "_Widget__container_changed", "_Widget__css_class_changed", "_Widget__icon_changed", "_Widget__make_singleton_container_widgets_work", "_Widget__style_changed", "_Widget__title_changed", "_Widget__update_tabindex", "_button_clicked", "_check_changed", "_radio_changed", "check_size"];
Example.prototype.__local_properties__ = ["parent", "size"];
Example.prototype.__properties__ = ["base_size", "children", "container", "css_class", "flex", "icon", "orientation", "parent", "pos", "size", "spacing", "style", "tabindex", "title"];

Example.prototype._button_clicked = function () {
    var ev, events;
    events = Array.prototype.slice.call(arguments);
    ev = events[events.length -1];
    this.buttonlabel.text = "Clicked on the " + ev.source.text;
    return null;
};
Example.prototype._button_clicked.nobind = true;
Example.prototype._button_clicked._connection_strings = ["b1.mouse_click", "b2.mouse_click", "b3.mouse_click"];

Example.prototype._check_changed = function () {
    var events, selected;
    events = Array.prototype.slice.call(arguments);
    selected = (function list_comprehension () {var res = [];var c, iter0, i0;iter0 = [this.c1, this.c2, this.c3];if ((typeof iter0 === "object") && (!Array.isArray(iter0))) {iter0 = Object.keys(iter0);}for (i0=0; i0<iter0.length; i0++) {c = iter0[i0];if (!(c.checked)) {continue;}{res.push(c.text);}}return res;}).apply(this);
    if (_pyfunc_truthy(selected)) {
        this.checklabel.text = "Selected: " + _pymeth_join.call(", ", selected);
    } else {
        this.checklabel.text = "None selected";
    }
    return null;
};
Example.prototype._check_changed.nobind = true;
Example.prototype._check_changed._connection_strings = ["c1.checked", "c2.checked", "c3.checked"];

Example.prototype._radio_changed = function () {
    var ev, events;
    events = Array.prototype.slice.call(arguments);
    ev = events[events.length -1];
    this.radiolabel.text = "Selected the " + ev.source.text;
    return null;
};
Example.prototype._radio_changed.nobind = true;
Example.prototype._radio_changed._connection_strings = ["r1.checked", "r2.checked", "r3.checked"];
